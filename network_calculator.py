#!/usr/bin/env python3
"""
Network Calculator Web App (No Dependencies)
A web interface for the Advanced Calculator accessible from any device on the network
"""
...
<head>
    ...
    <title>Advanced Calculator - Network Access</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="calculator-container">
        <div class="header">
            ...
            <p>Network Accessible Calculator - Ubuntu Server</p>
        </div>
        
        <div class="network-info">
            <h3>🌐 Network Access</h3>
            <p><strong>Server IP:</strong> 10.0.1.112</p>
            <p><strong>Access from Mac:</strong> http://10.0.1.112:8001</p>
...
def run_server(port=8001):
    ...
    with socketserver.TCPServer(("0.0.0.0", port), handler) as httpd:
        print("=" * 60)
        print("🧮 Advanced Calculator Web App - Network Access")
        print("=" * 60)
        print(f"🌐 Server running on ALL interfaces (0.0.0.0:{port})")
        print(f"📱 Local access: http://localhost:{port}")
        print(f"💻 Mac access: http://10.0.1.112:{port}")
